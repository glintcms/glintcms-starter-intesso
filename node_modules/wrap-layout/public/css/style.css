...
body {
  ...
  color: #63524A;
  /*background-image: url(/assets/wrap-layout/bg.png);*/
}
...
.cke_dialog *,
a.cke_combo_button,
a.cke_dialog_ui_button.cke_dialog_ui_button,
.cke_dialog_body.cke_dialog_body,
select.cke_dialog_ui_input_select.cke_dialog_ui_input_select,
input.cke_dialog_ui_input_text.cke_dialog_ui_input_text,
input.cke_dialog_ui_input_password.cke_dialog_ui_input_password,
textarea.cke_dialog_ui_input_textarea.cke_dialog_ui_input_textarea {
